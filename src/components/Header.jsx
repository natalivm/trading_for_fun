  ...
  return (
    <header className="sticky top-0 z-10 border-b border-slate-800/50 bg-slate-950/90 backdrop-blur-xl">
      <div className="mx-auto max-w-5xl px-4 sm:px-8">
        ...
        {/* Stats row */}
        <div className="flex items-center gap-6 border-t border-slate-800/40 py-3">
          ...
          {hasDailyData && (
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-base font-bold tabular-nums ${dailyPositive ? 'text-emerald-400' : 'text-red-400'}`}>
