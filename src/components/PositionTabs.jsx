...
const defaultLongPositions = [
  ...
  { ticker: 'CEG', status: 'open', entryPrice: 310.77, quantity: 2, openDate: '2026-02-12', unrealizedPnL: (326.07 - 310.77) * 2, profitPercent: ((326.07 - 310.77) / 310.77) * 100 },
  ...
  { ticker: 'THM', status: 'open', entryPrice: 2.93, quantity: 100, openDate: '2026-02-25', unrealizedPnL: (2.92 - 2.93) * 100, profitPercent: ((2.92 - 2.93) / 2.93) * 100 },
  ...
  { ticker: 'CEG', status: 'open', entryPrice: 319.18, quantity: 2, openDate: '2026-03-03', unrealizedPnL: (326.07 - 319.18) * 2, profitPercent: ((326.07 - 319.18) / 319.18) * 100 },
  ...
  { ticker: 'THM', status: 'open', entryPrice: 3.32, quantity: 100, openDate: '2026-03-03', unrealizedPnL: (2.92 - 3.32) * 100, profitPercent: ((2.92 - 3.32) / 3.32) * 100 },
...
const defaultShortPositions = [
  ...
  { ticker: 'POWL', status: 'open', entryPrice: 487.26, quantity: 1, openDate: '2026-03-07', unrealizedPnL: (487.26 - 489.87) * 1, profitPercent: ((487.26 - 489.87) / 487.26) * 100 },
