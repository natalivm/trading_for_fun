...
// Tickers to ignore during IBKR sync (leftovers, corporate actions, etc.)
...
export const defaultClosedLongPositions = [
  ...
  },
  {
    ticker: 'PINS',
    status: 'closed',
    entryPrice: (20 * 23.87 + 30 * 22.25) / 50,
    quantity: 50,
    exitPrice: 23.73,
    profitDollar: (23.73 - (20 * 23.87 + 30 * 22.25) / 50) * 50,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-30',
    closeDate: '2026-02-03',
  },
  {
    ticker: 'PANW',
    status: 'closed',
    entryPrice: (2 * 210 + 3 * 218) / 5,
    quantity: 5,
    exitPrice: (2 * 195.78 + 3 * 196.54) / 5,
    profitDollar: ((2 * 195.78 + 3 * 196.54) / 5 - (2 * 210 + 3 * 218) / 5) * 5,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-21',
    closeDate: '2026-01-28',
  },
  {
    ticker: 'PLTR',
    status: 'closed',
    entryPrice: (80 * 118.9) / 80,
    quantity: 80,
    exitPrice: (40 * 117.76 + 40 * 115) / 80,
    profitDollar: ((40 * 117.76 + 40 * 115) - (80 * 118.9)),
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-27',
    closeDate: '2026-02-03',
  },
  {
    ticker: 'CRWD',
    status: 'closed',
    entryPrice: (5 * 412 + 5 * 410.44) / 10,
    quantity: 10,
    exitPrice: (5 * 406.07 + 5 * 404.93) / 10,
    profitDollar: ((5 * 406.07 + 5 * 404.93) / 10 - (5 * 412 + 5 * 410.44) / 10) * 10,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-28',
    closeDate: '2026-01-29',
  },
  {
    ticker: 'GOOG',
    status: 'closed',
    entryPrice: (1 * 213.81 + 4 * 211) / 5,
    quantity: 5,
    exitPrice: (2 * 211.69 + 3 * 213.08) / 5,
    profitDollar: ((2 * 211.69 + 3 * 213.08) / 5 - (1 * 213.81 + 4 * 211) / 5) * 5,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-29',
    closeDate: '2026-01-29',
  },
  {
    ticker: 'AAPL',
    status: 'closed',
    entryPrice: (5 * 228.47 + 5 * 221.89) / 10,
    quantity: 10,
    exitPrice: 228.22,
    profitDollar: (228.22 - (5 * 228.47 + 5 * 221.89) / 10) * 10,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-28',
    closeDate: '2026-02-03',
  },
  {
    ticker: 'LRCX',
    status: 'closed',
    entryPrice: (2 * 71.85 + 2 * 69.95) / 4,
    quantity: 4,
    exitPrice: 68.14,
    profitDollar: (68.14 - (2 * 71.85 + 2 * 69.95) / 4) * 4,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-28',
  ...
  },
  {
    ticker: 'SOUN',
    status: 'closed',
    entryPrice: (100 * 15.4 + 100 * 14.2) / 200,
    quantity: 200,
    exitPrice: (100 * 13.86 + 100 * 13.43) / 200,
    profitDollar: ((100 * 13.86 + 100 * 13.43) - (100 * 15.4 + 100 * 14.2)),
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-29',
    closeDate: '2026-01-30',
  },
  ...
  },
  {
    ticker: 'MSTR',
    status: 'closed',
    entryPrice: (5 * 396 + 5 * 360) / 10,
    quantity: 10,
    exitPrice: (5 * 348.93 + 5 * 342.72) / 10,
    profitDollar: ((5 * 348.93 + 5 * 342.72) / 10 - (5 * 396 + 5 * 360) / 10) * 10,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-27',
    closeDate: '2026-02-03',
  },
  {
    ticker: 'TSLA',
    status: 'closed',
    entryPrice: (5 * 421.69 + 5 * 415.66) / 10,
    quantity: 10,
    exitPrice: 384.39,
    profitDollar: (384.39 - (5 * 421.69 + 5 * 415.66) / 10) * 10,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-24',
    closeDate: '2026-02-03',
  },
  {
    ticker: 'MRVL',
    status: 'closed',
    entryPrice: (5 * 117.97 + 5 * 119.13) / 10,
    quantity: 10,
    exitPrice: (5 * 115.43 + 5 * 115.12) / 10,
    profitDollar: ((5 * 115.43 + 5 * 115.12) / 10 - (5 * 117.97 + 5 * 119.13) / 10) * 10,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-20',
  ...
  },
  {
    ticker: 'SMCI',
    status: 'closed',
    entryPrice: (25 * 32.20 + 25 * 30.68) / 50,
    quantity: 50,
    exitPrice: 30.36,
    profitDollar: (30.36 - (25 * 32.20 + 25 * 30.68) / 50) * 50,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-02-11',
    closeDate: '2026-02-18',
  },
  {
    ticker: 'INTC',
    status: 'closed',
    entryPrice: (7 * 21.15 + 3 * 22.27) / 10,
    quantity: 10,
    exitPrice: 21.87,
    profitDollar: (21.87 - (7 * 21.15 + 3 * 22.27) / 10) * 10,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-02-06',
    closeDate: '2026-02-11',
  },
  {
    ticker: 'RR',
    status: 'closed',
    entryPrice: (30 * 740.63) / 30,
    quantity: 30,
    exitPrice: (30 * 803.87) / 30,
    profitDollar: 30 * 803.87 - 30 * 740.63,
    fees: 2 * FEE_PER_TRANSACTION,
    openDate: '2026-02-12',
    closeDate: '2026-02-26',
    currency: 'GBP',
  ...
  },
  {
    ticker: 'MRVL',
    status: 'closed',
    entryPrice: (2 * 96.40 + 3 * 96.45) / 5,
    quantity: 5,
    exitPrice: 92.81,
    profitDollar: (92.81 - (2 * 96.40 + 3 * 96.45) / 5) * 5,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-02-24',
    closeDate: '2026-03-04',
  },
  {
    ticker: 'COGT',
    status: 'closed',
    entryPrice: (20 * 34.75 + 15 * 33.80) / 35,
    quantity: 35,
    exitPrice: 39.95,
    profitDollar: (39.95 - (20 * 34.75 + 15 * 33.80) / 35) * 35,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-07',
    closeDate: '2026-01-22',
  },
  {
    ticker: 'OKTA',
    status: 'closed',
    entryPrice: (3 * 68.9 + 2 * 71.12) / 5,
    quantity: 5,
    exitPrice: 71.4,
    profitDollar: (71.4 - (3 * 68.9 + 2 * 71.12) / 5) * 5,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-01-27',
    closeDate: '2026-02-05',
  },
  {
    ticker: 'CCJ',
    status: 'closed',
    entryPrice: (2 * 49.62 + 3 * 48.57) / 5,
    quantity: 5,
    exitPrice: (3 * 46.60 + 2 * 46.50) / 5,
    profitDollar: ((3 * 46.60 + 2 * 46.50) / 5 - (2 * 49.62 + 3 * 48.57) / 5) * 5,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-01-28',
    closeDate: '2026-02-04',
  },
  {
    ticker: 'SMCI',
    status: 'closed',
    entryPrice: (7 * 24.59 + 7 * 25.02 + 14 * 24.30) / 28,
    quantity: 28,
    exitPrice: 23.33,
    profitDollar: (23.33 - (7 * 24.59 + 7 * 25.02 + 14 * 24.30) / 28) * 28,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-02-19',
    closeDate: '2026-03-03',
  },
  {
    ticker: 'OKLO',
    status: 'closed',
    entryPrice: (10 * 39 + 10 * 39.18) / 20,
    quantity: 20,
    exitPrice: (10 * 40.30 + 10 * 43.40) / 20,
    profitDollar: ((10 * 40.30 + 10 * 43.40) / 20 - (10 * 39 + 10 * 39.18) / 20) * 20,
    fees: 4 * FEE_PER_TRANSACTION,
    openDate: '2026-02-06',
    closeDate: '2026-02-18',
  },
  ...
  },
  {
    ticker: 'PRAX',
    status: 'closed',
    entryPrice: (5 * 79.07 + 5 * 78.13) / 10,
    quantity: 10,
    exitPrice: 77.36,
    profitDollar: (77.36 - (5 * 79.07 + 5 * 78.13) / 10) * 10,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-02-05',
    closeDate: '2026-02-12',
  },
  {
    ticker: 'AAPL',
    status: 'closed',
    entryPrice: (5 * 228 + 5 * 224.99) / 10,
    quantity: 10,
    exitPrice: 227.6,
    profitDollar: (227.6 - (5 * 228 + 5 * 224.99) / 10) * 10,
    fees: 3 * FEE_PER_TRANSACTION,
    openDate: '2026-02-19',
    closeDate: '2026-02-24',
  },
  {
    ticker: 'META',
    status: 'closed',
    entryPrice: (1 * 672 + 1 * 682 + 1 * 662 + 1 * 676 + 1 * 661) / 5,
    quantity: 5,
    exitPrice: (2 * 700 + 3 * 696.62) / 5,
    profitDollar: ((2 * 700 + 3 * 696.62) / 5 - (1 * 672 + 1 * 682 + 1 * 662 + 1 * 676 + 1 * 661) / 5) * 5,
    fees: 6 * FEE_PER_TRANSACTION,
    openDate: '2026-01-13',
